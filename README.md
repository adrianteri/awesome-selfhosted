...
- [Homebox](https://hay-kot.github.io/homebox/) - An inventory and organization system built for the home user. ([Demo](https://homebox.fly.dev/), [Source_Code](https://github.com/hay-kot/homebox)) `AGPL-3.0` `Go` `Vue.Js`
